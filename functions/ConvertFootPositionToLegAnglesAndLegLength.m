%% Calculate corresponding leg angles and leg length for a 3D foot position
% Saturates leg length at max_leg_length
%
% Outputs:
...
%
% Inputs:
%     X:                x position of foot relative to COM
%     Y:                y position of foot relative to COM
%     Z:                z position of foot relative to COM
...
function [Alpha, Beta, LegLength]  =  ...
          ConvertFootPositionToLegAnglesAndLegLength(X, Y, Z, right_left,...
                                                     com_pelvis_body, dcom_pelvis_body,...
                                                     q, dq, ...
                                                     lateral_offset, max_leg_length)                                             
    ...
    if ~right_left
        ...
        if l_star_L >= max_leg_length
            l_star_L = max_leg_length - 0.01; dl_star_L = 0; ddl_star_L = 0;
        end
    ...
    %% Right Leg
        ...
        if l_star_R >= max_leg_length
            l_star_R = max_leg_length - 0.01; dl_star_R = 0; ddl_star_R = 0;
        end
