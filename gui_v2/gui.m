...
% Last Modified by GUIDE v2.5 22-Jul-2014 17:29:58
...
%data = cell(27,2);
data = {'Motor Torque Saturation','UpperLimit',0
...
% --- Executes on button press in enable_btn.
function enable_btn_Callback(hObject, eventdata, handles)
% hObject    handle to enable_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
tg = evalin('base', 'tg');
tg.setparam(tg.getparamid('', 'gui_state_cmd'), evalin('base', 'MEDULLA_STATE_RUN'));

% --- Executes on button press in disable_btn.
function disable_btn_Callback(hObject, eventdata, handles)
% hObject    handle to disable_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
tg = evalin('base', 'tg');
tg.setparam(tg.getparamid('', 'gui_state_cmd'), evalin('base', 'MEDULLA_STATE_IDLE'));
...
% handles    structure with handles and user data (see GUIDATA)
tg = evalin('base', 'tg');
tg.setparam(tg.getparamid('', 'gui_state_cmd'), evalin('base', 'MEDULLA_STATE_RESET'));