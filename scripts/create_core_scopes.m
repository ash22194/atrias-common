...
% Positions
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s3'])); % right front leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s4'])); % right front gear
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s1'])); % right back leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s2'])); % right back gear
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s7'])); % left front leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s8'])); % left front gear
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s5'])); % left back leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s6'])); % left back gear
...
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s11'])); % boom roll 
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s12'])); % boom yaw 
fscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals/s13'])); % boom pitch 
% Velocities
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s3'])); % front right leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s4'])); % front right motor
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s1'])); % back right leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s2'])); % back right motor
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s7'])); % front left  leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s8'])); % front left motor
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s5'])); % back left leg
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s6'])); % back left motor
...
fscopes(1).addsignal(getsignalid(tg,[system_path 'dq_signals/s11'])); % boom roll 
...
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s1'])); % right back leg
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s2'])); % right back motor
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s3'])); % right front leg
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s4'])); % right front motor
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s5'])); % left back leg
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s6'])); % left back motor
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s7'])); % left front leg
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s8'])); % left front motor
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s9'])); % right lateral
% tscopes(1).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s10'])); % left lateral
% 
% % Boom positions
% tscopes(2).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s11'])); % boom roll
% tscopes(2).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s12'])); % boom yaw
% tscopes(2).addsignal(getsignalid(tg,[system_path 'q_signals_degrees/s13'])); % boom pitch
% tscopes.start();
