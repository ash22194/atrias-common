...
%% Full Robot
m_total_real = 65.64; % kg (measured on force plate with boom attached)
...
com_torso = [0.010, -0.070, 0.2885]; % m, Coordinates from pelvis.
i_torso = [1.5, 2.2, 1.5];
...
i_robot = 2*m_leg_motor*d_vertical_com^2 + m_torso*d_vertical_com_to_trunk_com^2 + i_torso(2) + 2*i_leg_motor(2); % kg m^2, y principal component