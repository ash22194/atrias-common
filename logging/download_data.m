...
inc_positions_recorded = data(:,67:70);
inc_velocities_recorded = data(:,71:74);
elmo_statuses_recorded = data(:,75:78);
elmo_error_codes_recorded = data(:,79:82);
