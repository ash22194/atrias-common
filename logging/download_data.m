...
elmo_torque_demands_recorded = data(:,56:59);
motors_enabled_recorded = data(:,60);
inc_positions_recorded = data(:,61:64);
inc_velocities_recorded = data(:,65:68);
elmo_statuses_recorded = data(:,69:72);
elmo_error_codes_recorded = data(:,73:76);
elmo_velocity_demands_recorded = data(:,77:80);
...
save(file_name, 'time_recorded','q_recorded','dq_recorded','accelerometer_recorded','tau_recorded','velocity_command_recorded','velocity_mode_recorded','elmo_velocity_recorded','elmo_velocity_demands_recorded','elmo_torque_recorded','desired_sea_torques_recorded','elmo_torque_demands_recorded','motors_enabled_recorded','inc_positions_recorded','inc_velocities_recorded','elmo_statuses_recorded','elmo_error_codes_recorded','tet_recorded');